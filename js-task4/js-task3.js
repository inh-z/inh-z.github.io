...
/*var peopleData=sessionStorage.peopleNumber;
alert(peopleData);//undefined*/

/*var peopleData = sessionStorage.getItem(peopleNumber);*/
	...
	if(j<=(peopleData.length)){
		if (clickNumber % 2 == 0){
			...
			if(j<=(peopleData.length)){
				...
				document.getElementById('continue').innerHTML='法官查看';
			}
		}
	}
	else{
